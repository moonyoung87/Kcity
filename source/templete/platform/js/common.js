$(document).ready(function () {
	...
	/*동영상 자막토글*/
	var btnText = $('.video-caption-open').text();
	$('.video-caption-open').on('click',function(){
		var btnText = $(this).text();
		$(this).toggleClass('on');
		$(this).siblings('.txt-box').toggle();
		$('.video-caption-open').text(
        btnText == "자막보기" ? "자막닫기" : "자막보기");
	});

	/*최근본목록 토글*/
	/*var btnText = $('.my-history .btn-close').text();
	$('.my-history .btn-close').on('click',function(){
		var btnText = $(this).text();
		$(this).toggleClass('on');
		$('.my-history-list').slideToggle();
		$('.my-history .btn-close').text(
        btnText == "닫기" ? "열기" : "닫기");
	});
	$('#drag').draggable();
	*/
