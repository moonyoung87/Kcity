...
(function() {
    ...
    b = window.Morris = {}, a = jQuery, b.EventEmitter = function() {
        ...
        return h(d, c), d.prototype.gridDefaults = {
            ...
            var b, c;
            return this.options.horizontal ? (c = this.left, b = this.right) : (c = this.top, b = this.bottom), 1 === this.data.length ? (c + b) / 2 : 16 + c + (a - this.xmin) * this.dx
        ...
        return h(c, a), c.prototype.init = function() {
        	...
        	if (this.options.xAxisTop) {
        		b = this.options.xAxisTopPos;
        	}
