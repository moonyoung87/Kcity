$(document).ready(function () {
	...
	videoOpen.on('click',function(){
		$("#video").attr("src","/resource/templete/katri/img/main/video-full.mp4");
		video.get(0).play();
	});
	...
	function mainTab() {
		...
		tabBtn.on('click',function(e){
			...
			$(tabCon).children().find(".img-box>img").attr("src","/resource/templete/katri/img/main/performance-img"+tabCon.charAt(tabCon.length-1)+".jpg");
